            ...
            <div class="row align-items-center pt-4">
                <div class="col">
                            ...
                            <div class="row g-2 p-2">
                                <div class="col">
                                  <div class="form-floating">
                                    ...
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Room Number" name="roomNo" size="100" required>                                    
                                  </div>
                                </div>
                                <div class="col-md">
                                  <div class="form-floating">
                                    <label for="floatingInput">Room Type</label>
                                    <select class="form-control" id="floatingInput" placeholder="Room Type" name="roomType" required>
                                        <option></option>
                            ...
                            <div class="row g-2 p-2">
                                <div class="col">
                                  <div class="form-floating">
                                    ...
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Room Fee" name="roomPrice" size="100" required>                                    
                                  </div>
                                </div>
                                <div class="col-md">
                                  <div class="form-floating">
                                    <label for="floatingSelect">Room Image</label>
                                    <input type="file" class="form-control" id="floatingInput" placeholder="Image of the Room" name="roomImage" size="100" required>                                    
                                  </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto pt-1">
                        <input class="btn btn-warning" type="reset" id="buttonreset" name="command" value="Reset Form">
                        <input class=" btn btn-primary" type="submit" id="button4" name="command" value="Add Room">                                            
                    </div>
